                    ...
                    <div class="col-lg-6 mb-4 order-0">
                        <div class="card">
                            <div class="d-flex align-items-end row">
                                <div class="col-sm-12">
                                    <div class="card-body">
                                        <h5 class="card-title text-primary">Campus Mission</h5>
                                        <p class="mb-4">
                                            Here you manage the campus mission cordinators and view reports.
                                        </p>    
                                        <a href="{{ route('campus.dashboard') }}" class="btn btn-sm btn-outline-primary">View Campus Mission</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 mb-4 order-0">
                        <div class="card">
                            <div class="d-flex align-items-end row">
                                <div class="col-sm-12">
                                    <div class="card-body">
                                        <h5 class="card-title text-primary">Bible Study</h5>
                                        <p class="mb-4">
                                            Here you can manage the Bible study courses, lessons and tutors.
                                        </p>    
                                        <a href="{{ route('bible.dashboard') }}" class="btn btn-sm btn-outline-primary">View Bible Study</a>
                                    </div>
                                </div>
                            </div>
                        </div>
