...
<style>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <div class="d-flex flex-wrap justify-content-between gap-3" style="padding-top:0">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Lessons /</span> {{ $lesson->title }} </h4>
                          ...
                          <div class="card academy-content shadow-none border">
                            <div class="p-2">
                                <div class="ratio ratio-16x9">
                                    <iframe width="100%" height="315" src="https://www.youtube.com/embed/R4a829TG2qM?si=M3rt56lIMV4z1e1X" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    @foreach ($lessons as $lesson)
                                        ...
                                        <div class="form-check d-flex align-items-center mb-3">
                                            ...
                                            <label for="lesson_{{ $lesson->id }}" class="form-check-label ms-3">
                                                ...
                                                <span class="text-muted d-block">{{ $lesson->duration }} min</span>
                                            </label>
                                        </div>
