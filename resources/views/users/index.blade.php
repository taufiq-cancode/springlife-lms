          ...
          <div class="col-lg-12">
            <div class="nav-align-top mb-4">
              <ul class="nav nav-pills mb-3" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-top-home" aria-controls="navs-pills-top-home" aria-selected="false" tabindex="-1">All users</button>
                </li>
              </ul>
                                              ...
                                              <div class="modal-body">
                                                  <div class="row">
                                                    <div class="col-6 mb-3">
                                                        ...
                                                        <input type="text" id="nameWithTitle" name="firstname" value="{{ $tutor->firstname }}" class="form-control" required placeholder="Enter tutor's firstname">
                                                    </div>
                                                    <div class="col-6 mb-3">
                                                      <label for="nameWithTitle" class="form-label">Lastname</label>
                                                      <input type="text" id="nameWithTitle" name="lastname" value="{{ $tutor->lastname }}" class="form-control" required placeholder="Enter tutor's lastname">
                                                    </div>
                                                  </div>
                                                  ...
                                                  <div class="row">
                                                    <div class="col mb-3">
                                                        ...
                                                        <input type="text" id="nameWithTitle" name="email" value="{{ $tutor->email }}" class="form-control" required placeholder="Enter tutor's email address">
                                                    </div>
                                                  </div>
                                                  ...
                                                  <div class="row">
                                                      <div class="col mb-3">
                                                          ...
                                                          <select id="defaultSelect" name="course_id" required class="form-select">                                
                                            ...
                                            <form method="POST" action="{{ route('admin.update', ['adminId' => $admin->id]) }}" enctype="multipart/form-data">
                                              ...
                                              <div class="modal-body">
                                                  <div class="row">
                                                    <div class="col-6 mb-3">
                                                        <label for="nameWithTitle" class="form-label">Firstname</label>
                                                        <input type="text" id="nameWithTitle" name="firstname" value="{{ $admin->firstname }}" class="form-control" required placeholder="Enter admin's firstname">
                                                    </div>
                                                    <div class="col-6 mb-3">
                                                      <label for="nameWithTitle" class="form-label">Lastname</label>
                                                      <input type="text" id="nameWithTitle" name="lastname" value="{{ $admin->lastname }}" class="form-control" required placeholder="Enter admin's lastname">
                                                    </div>
                                                  </div>
            ...
            <form method="POST" action="{{ route('tutor.store') }}" enctype="multipart/form-data">
              ...
              <div class="modal-body">
                  <div class="row">
                    <div class="col-6 mb-3">
                        <label for="nameWithTitle" class="form-label">Firstname</label>
                        <input type="text" id="nameWithTitle" name="firstname" class="form-control" required placeholder="Enter tutor's firstname">
                    </div>
                    <div class="col-6 mb-3">
                      <label for="nameWithTitle" class="form-label">Lastname</label>
                      <input type="text" id="nameWithTitle" name="lastname" class="form-control" required placeholder="Enter tutor's lastname">
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col mb-3">
                        <label for="nameWithTitle" class="form-label">Email Address</label>
                        <input type="text" id="nameWithTitle" name="email" class="form-control" required placeholder="Enter tutor's email address">
                    </div>
                  </div>
